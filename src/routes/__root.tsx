...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "seguranca-odontologica.com.br" },
      { name: "description", content: "Safe Smile Guide educates patients on dental safety, error prevention, and patient rights." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "seguranca-odontologica.com.br" },
      { property: "og:description", content: "Safe Smile Guide educates patients on dental safety, error prevention, and patient rights." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "seguranca-odontologica.com.br" },
